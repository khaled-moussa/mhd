	...
	<div class="modal-overlay" tabindex="-1" data-micromodal-close>
		<div class="modal-container lg" role="dialog" aria-modal="true" aria-labelledby="{{ $modalId }}-title">
			...
			<main class="modal-content" id="{{ $modalId }}-content">
				<div x-data="viewServiceComponent" class="service-view">
					<div class="service-view-row">
						{{-- Title --}}
						<x-label.info label="Title" xDescription="serviceData.title" />
					</div>

					<div class="service-view-row">
						{{-- Description --}}
						<x-label.info label="Description" xDescription="serviceData.description" />
					</div>
				</div>
			</main>
		</div>
