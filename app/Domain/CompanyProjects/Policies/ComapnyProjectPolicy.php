...
namespace App\Domain\CompanyProjects\Policies;

use App\Domain\CompanyProjects\Models\CompanyProject;
use App\Domain\Users\Models\User;
use App\Support\Policies\BasePolicy;

class ComapnyProjectPolicy extends BasePolicy
{
    /**
     ...
     */
    public function view(User $user, CompanyProject $model): bool
    {
     ...
     */
    public function update(User $user, CompanyProject $model): bool
    {
     ...
     */
    public function delete(User $user, CompanyProject $model): bool
    {
     ...
     */
    public function forceDelete(User $user, CompanyProject $model): bool
    {
